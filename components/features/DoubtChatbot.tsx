    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full bg-gradient-to-br from-primary to-[#9F7AEA] text-primary-foreground shadow-soft-lg hover:scale-105 active:scale-95 transition-all flex items-center justify-center group"
      ...
      {open && (
        <>
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between gap-3 px-4 py-3 border-b bg-gradient-to-r from-primary/10 via-accent/40 to-card rounded-t-2xl">
              <div className="flex items-center gap-2.5 min-w-0">
                <div className="relative h-9 w-9 rounded-xl bg-gradient-to-br from-primary to-[#9F7AEA] flex items-center justify-center shadow-pill shrink-0">
              ...
              {messages.map((m, i) =>
                m.role === 'user' ? (
                  ...
                  <div key={i} className="flex gap-2.5">
                    <div className="h-7 w-7 rounded-full bg-gradient-to-br from-primary to-[#9F7AEA] flex items-center justify-center shrink-0 shadow-pill">
